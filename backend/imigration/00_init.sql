...
CREATE TABLE IF NOT EXISTS employees (
    ...
    post_function_alw_month NUMERIC DEFAULT 0.00,
    bpjs_health_tambahan_status TEXT DEFAULT '0',
    date_of_birth TEXT DEFAULT '',
    phone_alw_month NUMERIC DEFAULT 0.00,
    internet_alw_month NUMERIC DEFAULT 0.00,
    incentive_month NUMERIC DEFAULT 0.00,
    operational_alw_month NUMERIC DEFAULT 0.00,
    housing_alw_month NUMERIC DEFAULT 0.00,
    seniority_alw_month NUMERIC DEFAULT 0.00,
    transport_alw_month NUMERIC DEFAULT 0.00,
    field_alw_month NUMERIC DEFAULT 0.00,
    accommodation_alw_month NUMERIC DEFAULT 0.00,
    ...
    st_day NUMERIC DEFAULT 0.00,
    tr_day NUMERIC DEFAULT 0.00,
...
CREATE TABLE IF NOT EXISTS salaries (
  ...
  ew_wages NUMERIC DEFAULT 0.00,
   age NUMERIC DEFAULT 0,
    total_fixed_alw NUMERIC DEFAULT 0,
    work_alw NUMERIC DEFAULT 0,
    on_alw NUMERIC DEFAULT 0,
    osoa_alw NUMERIC DEFAULT 0,
    ot_alw NUMERIC DEFAULT 0,
    ovt_alw NUMERIC DEFAULT 0,
    bt_alw NUMERIC DEFAULT 0,
    t_alw NUMERIC DEFAULT 0,
    tnt_alw NUMERIC DEFAULT 0,
    al_alw NUMERIC DEFAULT 0,
    rot_alw NUMERIC DEFAULT 0,
    tr_alw NUMERIC DEFAULT 0,
    st_alw NUMERIC DEFAULT 0,
    ls_alw NUMERIC DEFAULT 0,
    total_non_fixed_alw NUMERIC DEFAULT 0,
    q_ded NUMERIC DEFAULT 0,
    pl_ded NUMERIC DEFAULT 0,
    late_ded NUMERIC DEFAULT 0,
    sc_ded NUMERIC DEFAULT 0,
    sc1_ded NUMERIC DEFAULT 0,
    co_ded NUMERIC DEFAULT 0,
    pm_ded NUMERIC DEFAULT 0,
    na_ded NUMERIC DEFAULT 0,
    salary_ded NUMERIC DEFAULT 0,
    jkk_alw NUMERIC DEFAULT 0,
    jkm_alw NUMERIC DEFAULT 0,
    jht_alw NUMERIC DEFAULT 0,
    jp_alw NUMERIC DEFAULT 0,
    bpjs_manpower_alw NUMERIC DEFAULT 0,
    bpjs_health_alw NUMERIC DEFAULT 0,
    gross_salary NUMERIC DEFAULT 0,
    jht_ded NUMERIC DEFAULT 0,
    jp_ded NUMERIC DEFAULT 0,
...
CREATE TABLE attendances (
    ...
    t NUMERIC DEFAULT 0,
    tnt NUMERIC DEFAULT 0,
    al NUMERIC DEFAULT 0,
    rot NUMERIC DEFAULT 0,
    tr NUMERIC DEFAULT 0,
    st NUMERIC DEFAULT 0,
    ls NUMERIC DEFAULT 0,
    q NUMERIC DEFAULT 0,
    wfh NUMERIC DEFAULT 0,
    pl NUMERIC DEFAULT 0,
    l NUMERIC DEFAULT 0,
    sc NUMERIC DEFAULT 0,
    sc1 NUMERIC DEFAULT 0,
    co NUMERIC DEFAULT 0,
    pm NUMERIC DEFAULT 0,
    na NUMERIC DEFAULT 0,
...
CREATE TABLE incidents (
    ...
    thr NUMERIC default 0.00,
    bonus NUMERIC default 0.00,
    compensation NUMERIC default 0.00,
    acting_alw NUMERIC default 0.00,
    salary_prorate NUMERIC default 0.00,
    rapel NUMERIC default 0.00,
    tax_alw NUMERIC default 0.00,
    tax_ded NUMERIC default 0.00,
    other_add NUMERIC default 0.00,
    other_ded NUMERIC default 0.00,
...
(5400001.0,5650000.0,0.0025,'TK/0,TK/1,K/0'),
(5650001.0,5950000.0,0.005,'TK/0,TK/1,K/0'),
(5950001.0,6300000.0,0.0075,'TK/0,TK/1,K/0'),
(6300001.0,6750000.0,0.01,'TK/0,TK/1,K/0'),
(6750001.0,7500000.0,0.0125,'TK/0,TK/1,K/0'),
(7500001.0,8550000.0,0.015,'TK/0,TK/1,K/0'),
(8550001.0,9650000.0,0.0175,'TK/0,TK/1,K/0'),
(9650001.0,10050000,0.02,'TK/0,TK/1,K/0'),
