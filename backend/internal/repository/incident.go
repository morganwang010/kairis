...
func (r *IncidentRepository) List(offset, limit int, projectID, month, employeeID, employeeName string) ([]IncidentWithEmployee, int64, error) {
	var incidents []IncidentWithEmployee
	var total int64

	// 构建基础查询条件
	query := r.db.Table("incidents as a").
