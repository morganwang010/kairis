...
// 页面加载时设定当前月份
  ...
  const columns: ColumnsType<IncidentRecord> = [
    ...
    { title: t('incidentPage.mealAlwAdd'), dataIndex: 'meal_alw_add', key: 'meal_alw_add', width: 120, render: (text) => text > 0 ? <ScientificNumberDisplay value={text} /> : '-' },
    { title: t('incidentPage.transpAlwAdd'), dataIndex: 'transp_alw_add', key: 'transp_alw_add', width: 120, render: (text) => text > 0 ? <ScientificNumberDisplay value={text} /> : '-' },
    { title: t('incidentPage.ewDrv'), dataIndex: 'ew_drv', key: 'ew_drv', width: 120, render: (text) => text > 0 ? <ScientificNumberDisplay value={text} /> : '-' },
